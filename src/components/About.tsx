    ...
    <section id="about-me" className="section-padding bg-transparent border-t border-white/5">
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          {/* Profile Image (lg:col-span-5) */}
          <div className="lg:col-span-5 w-full flex justify-center">
            <AnimatedWrapper type="scaleReveal" delay={0.1} className="relative w-full max-w-[400px] lg:max-w-none aspect-[3/4] rounded-3xl overflow-hidden border border-white/10 group bg-zinc-900 shadow-2xl">
              <Image
              ...
              <div className="mb-8">
                ...
                <div className="flex flex-wrap gap-2">
                  {skills.map((skill) => (
                    <span
                      key={skill}
                      className="px-3.5 py-1.5 rounded-full text-xs font-sans font-medium text-white/80 bg-white/5 border border-white/5 hover:border-white/10 hover:bg-white/10 transition-all duration-200 cursor-default"
                    >
                      {skill}
                    </span>
                  ))}
              ...
              <div className="mb-10">
                ...
                <div className="flex flex-wrap gap-2">
                  {tools.map((tool) => (
                    <span
                      key={tool}
                      className="px-3.5 py-1.5 rounded-full text-xs font-mono text-gold bg-gold/5 border border-gold/10 hover:bg-gold/10 transition-all duration-200 cursor-default"
                    >
                      {tool}
                    </span>
                  ))}
