          ...
          <div className="lg:col-span-5 flex flex-col items-start pr-0 lg:pr-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Twitter"
                className="w-11 h-11 rounded-xl bg-white/[0.03] border border-white/10 flex items-center justify-center text-white/60 hover:text-[#1DA1F2] hover:border-[#1DA1F2]/40 hover:bg-[#1DA1F2]/10 hover:-translate-y-1.5 transition-all duration-300 shadow-sm"
              >
                <svg className="w-4.5 h-4.5 fill-current" viewBox="0 0 24 24">
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-8">
            <div className="hidden md:block relative max-w-[200px] overflow-hidden mask-gradient">
              <div className="animate-marquee-infinite text-xs font-mono font-medium tracking-widest text-white/40 uppercase whitespace-nowrap select-none">
